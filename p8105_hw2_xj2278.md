...
``` r
trash_wheel = read_excel("./data/Trash-Wheel-Collection-Totals-7-2021-sept.xlsx", 
                         range = "A2:N408", 
                         "Mr. Trash Wheel") %>% 
  na.omit("Dumpster") %>% 
  janitor::clean_names() %>% 
...
``` r
precipitation_2018 = read_excel("./data/Trash-Wheel-Collection-Totals-7-2021-sept.xlsx", 
                         range = "A2:B14", 
                         "2018 Precipitation") %>% 
  mutate(year = "2018")

precipitation_2019 = read_excel("./data/Trash-Wheel-Collection-Totals-7-2021-sept.xlsx", 
                         range = "A2:B8", 
                         "2019 Precipitation") %>% 
  mutate(year = "2019")
...
The trash wheel dataset has 345 observations and 14 variables, and key
...
month, total, year. The precipitation data ranges from 0.42 to 10.47.
